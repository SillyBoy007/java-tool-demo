...
import com.example.jmokit.mockuplibs.DubboConsumerBeanMockUp;
import com.example.jmokit.service.MailService;
import mockit.Mock;
...
public class DubboConsumerBeanMockingTest {
    ...
    public static void mockDubbo() {
        ...
        mockMap.put("com.example.jmokit.service.MailService", new MockUp(MailService.class) {
